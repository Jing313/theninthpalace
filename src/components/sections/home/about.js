			...
			<div class="container">
				...
				<div class="neoh_fn_about_item">
					...
					<div class="content_item">
						...
						<div class="desc">
							<p>The quality of the project means more to us than anything. We’ve been planning, writing, and designing for nearly a year. </p>
							<p>The project roadmap coincides with the story's narrative arc. The game economy, known as The Resistance Economy, is built on sustainability; game progressions and maps have been thoroughly planned. We're now in pre-production.</p>
							<p>We’re so excited to watch the community discover the secrets, the storylines within storylines, hidden within The Ninth Palace.</p>
						</div>
